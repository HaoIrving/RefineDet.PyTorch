...
# python train_refinedet.py --num_workers 12 --lr 4e-3 --save_folder weights/align_4e3_512res50/ --model 512_ResNet_50 --batch_size 16 --pretrained 
# python train_refinedet.py --num_workers 12 --lr 4e-3 --save_folder weights/align_4e3_512res101/ --model 512_ResNet_101 --batch_size 16 --pretrained 
# CUDA_VISIBLE_DEVICES=3,2 python train_refinedet.py --num_workers 12 --lr 4e-3 --save_folder weights/align_4e3_512res50/ --model 512_ResNet_50 --batch_size 16 --ngpu 2
...
############ dg3 #############
python train_refinedet_dg3.py --num_workers 12 --lr 4e-3 --save_folder weights/dg3_4e3_640vggbn/ --ngpu 4  --model 640_vggbn --batch_size 16 
CUDA_VISIBLE_DEVICES=3 python eval_refinedet_coco_dg3.py --prefix weights/dg3_4e3_640vggbn  --model 640_vggbn 
