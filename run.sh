...
python train_refinedet.py --num_workers 12 --lr 4e-3 --save_folder weights/at2_mh_pp_4e3_1_ce_640vggbn/ --ngpu 4 --batch_size 16 --model 640_vggbn -atce -at2
CUDA_VISIBLE_DEVICES=2 python eval_refinedet_coco.py --prefix weights/at2_mh_pp_4e3_1_ce_640vggbn --model 640_vggbn -at2
