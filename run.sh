...
# python train_refinedet.py --num_workers 16 --lr 2e-3 --save_folder weights/srn_rtcb_2e3/ 
...
python train_refinedet.py --num_workers 16 --lr 2e-3 --save_folder weights/lr_2e3/
python eval_refinedet_coco.py
