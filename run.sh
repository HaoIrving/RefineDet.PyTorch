...
# python train_refinedet.py --num_workers 12 --lr 4e-3 --save_folder weights/at1_mh2_4e3_1/ --ngpu 4 --batch_size 16 -aw 1
...
# python train_refinedet.py --num_workers 12 --lr 4e-3 --save_folder weights/at2_mh_4e3_05/ --ngpu 4 --batch_size 16 -aw 0.5
