...
# CUDA_VISIBLE_DEVICES=2,3 python train_refinedet.py --num_workers 12 --lr 4e-3 --save_folder weights/at1_mh_4e3_01_sigma1/ --ngpu 2 --batch_size 16 -aw 0.1
python train_refinedet.py --num_workers 12 --lr 4e-3 --save_folder weights/at1_mh_4e3_01_ce_sigma1/ --ngpu 2 --batch_size 16 -aw 0.1 -atce -atsg 1
