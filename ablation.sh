...
python train_refinedet.py --num_workers 12 --lr 4e-3 --save_folder weights/align_4e3_640vggbn_wo_align_refine_fuse/ --ngpu 4 --model 640_vggbn --batch_size 16  -wofuse
