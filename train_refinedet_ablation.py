...
from layers.modules import RefineDetMultiBoxLoss, AttentionFocalLoss, MultiBoxLoss
...
parser.add_argument('-woat', '--wo_attention', action="store_true", default=False, help=' ')
...
def train():
    ...
    for iteration in range(start_iter, max_iter):
        ...
        # forward
        if wo_refined_anchor:
            attention_maps, odm_loc, odm_conf = net(images)
            out = (odm_loc, odm_conf)
        else:
