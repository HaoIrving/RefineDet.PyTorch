...
def match(threshold, truths, priors, variances, labels, loc_t, conf_t, idx):
    ...
    conf = labels[best_truth_idx]         # Shape: [num_priors], + 1 when load foreground labels from 0
...
def refine_match(threshold, truths, priors, variances, labels, loc_t, conf_t, idx, arm_loc=None):
    ...
    if arm_loc is None:
        ...
        conf = labels[best_truth_idx]      # Shape: [num_priors], load foreground labels from 1 not 0
